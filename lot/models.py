...
class Lot(models.Model):
    ...
    materialize = models.BooleanField(verbose_name='Приз доставкой или онлайн', default=False)
    image = models.ImageField(verbose_name='Основное изображение', upload_to='lot/', null=True)
